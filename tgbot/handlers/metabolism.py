...
from tgbot.keyboards.metabolism import metabolism_gender_markup, metabolism_activity_markup, gender_callback, \
    activity_callback
from tgbot.misc.metabolism import metabolism_calculation
from tgbot.misc.states import Metabolism


async def enter_test(cb: types.CallbackQuery):
...
def register_metabolism_handlers(dp: Dispatcher):
    dp.register_callback_query_handler(enter_test, lambda callback_query: callback_query.data == "metabolism", chat_type=types.ChatType.PRIVATE)
